export function merge(cfg, env, environments, environmentName, logError, logInfo) {
...
export function mergeEnvironments(cfg, cfgEnv, logError, logInfo) {
  if (!cfgEnv) {
    return cfg;
  }
  const conf = cfg;
...
export function mergeEnv(cfg, env, logError, logInfo) {
  return mergeWithPath(Object.assign({}, cfg), env, undefined, logError, logInfo);
}
export function mergeWithPath(cfg, env, parentPath, logError, logInfo) {
  const conf = cfg;
